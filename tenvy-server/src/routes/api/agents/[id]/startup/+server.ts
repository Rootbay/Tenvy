...
function ensureDefinition(input: unknown): StartupEntryDefinition {
	...
	const publisher =
		typeof candidate.publisher === 'string' ? candidate.publisher.trim() || undefined : undefined;
	const description =
		typeof candidate.description === 'string'
			? candidate.description.trim() || undefined
			: undefined;
	const args =
		typeof candidate.arguments === 'string' ? candidate.arguments.trim() || undefined : undefined;
