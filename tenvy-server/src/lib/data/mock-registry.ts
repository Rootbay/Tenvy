...
const baseSnapshot: RegistrySnapshot = {
        HKEY_LOCAL_MACHINE: {
                ...
                'SOFTWARE\\Policies\\Microsoft\\Windows': key(
                        ...
                        'SOFTWARE\\Policies\\Microsoft',
                        [
                                value('DisableRegistryTools', 'REG_DWORD', '0x00000000', 'Allow registry editors', '2024-04-04T12:00:00Z'),
                                value('WindowsUpdateMode', 'REG_SZ', 'Managed', undefined, '2024-03-18T17:42:00Z'),
                                value('ComplianceTags', 'REG_MULTI_SZ', 'Baseline\nHardened\nPrivileged', undefined, '2024-05-09T11:00:00Z')
                        ],
                ...
                SYSTEM: key(
                        ...
                        [
                                ...
                                value('BuildLab', 'REG_SZ', '26100.560.amd64fre.ge_release', undefined, '2024-05-18T19:30:00Z'),
                ...
                'SYSTEM\\CurrentControlSet\\Services\\TenvyAgent': key(
                        ...
                        [
                                ...
                                value('Security', 'REG_BINARY', '01 00 04 80 7c 00 00 00 14 00 00 00', undefined, '2024-05-20T21:00:00Z')
                        ],
        ...
        HKEY_CURRENT_USER: {
                ...
                'SOFTWARE\\Tenvy': key(
                        ...
                        [
                                ...
                                value('RecentActivity', 'REG_MULTI_SZ', 'Bootstrap\nRecon\nCleanup', undefined, '2024-06-02T07:40:00Z'),
                                value('SessionTimeout', 'REG_DWORD', '0x0000001e', 'Timeout in minutes', '2024-06-01T12:00:00Z')
                        ],
                ...
                Environment: key(
                        ...
                        null,
                        [
                                value('Path', 'REG_EXPAND_SZ', '%USERPROFILE%\\bin;%PATH%', undefined, '2024-04-30T09:00:00Z'),
                                value('TENVY_SESSION', 'REG_SZ', 'alpha-02', undefined, '2024-06-02T08:10:00Z'),
                                value('TMP', 'REG_EXPAND_SZ', '%USERPROFILE%\\AppData\\Local\\Temp', undefined, '2024-04-12T15:30:00Z')
                        ],
        ...
        HKEY_USERS: {
                ...
                'S-1-5-21-1004336348-1177238915-682003330-512\\Software\\TenvyShared': key(
                        ...
                        'S-1-5-21-1004336348-1177238915-682003330-512\\Software',
                        [
                                value('SharedState', 'REG_BINARY', '10 00 00 00 02 00 00 00', undefined, '2024-03-11T09:00:00Z'),
...
export function normalizeHive(hive: RegistryHive): RegistryHive {
        ...
        for (const entry of Object.values(normalized)) {
                entry.subKeys = entry.subKeys
                        .filter((childPath, index, array) => array.indexOf(childPath) === index && normalized[childPath])
