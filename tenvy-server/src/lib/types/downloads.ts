...
export const downloadCatalogueEntrySchema: z.ZodType<DownloadCatalogueEntry> = z.object({
...
export const downloadCatalogueResponseSchema: z.ZodType<DownloadCatalogueResponse> = z.object({
