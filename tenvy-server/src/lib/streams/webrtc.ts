...
function normalizeIceServers(servers: RemoteDesktopWebRTCICEServer[]): RemoteDesktopWebRTCICEServer[] {
...
function toRtcIceServers(servers: RemoteDesktopWebRTCICEServer[]): RTCIceServer[] {
        return servers.map((server) => {
                ...
                } else if (server.credentialType === 'password' || (!server.credentialType && server.credential)) {
