		...
		<div class="grid gap-6 lg:grid-cols-2">
			<Card class="border-border/60">
				...
				<CardContent class="grid gap-4 text-sm sm:grid-cols-2">
					...
					<div>
						<p class="text-xs font-medium tracking-wide text-muted-foreground uppercase">Domain</p>
						<p class="mt-1 font-medium text-foreground">
							{report.host.domain ?? '—'}
						</p>
					</div>
			...
			<Card class="border-border/60">
				...
				<CardContent class="grid gap-4 text-sm sm:grid-cols-2">
					...
					<div>
						<p class="text-xs font-medium tracking-wide text-muted-foreground uppercase">Family</p>
						<p class="mt-1 font-medium text-foreground">
							{report.os.family ?? '—'}
						</p>
					</div>
					<div>
						<p class="text-xs font-medium tracking-wide text-muted-foreground uppercase">Version</p>
						<p class="mt-1 font-medium text-foreground">
							{report.os.version ?? '—'}
						</p>
					</div>
					<div>
						<p class="text-xs font-medium tracking-wide text-muted-foreground uppercase">Kernel</p>
						<p class="mt-1 font-medium text-foreground">
			...
			<Card class="border-border/60">
				...
				<CardContent class="grid gap-4 text-sm sm:grid-cols-2">
					...
					<div>
						<p class="text-xs font-medium tracking-wide text-muted-foreground uppercase">Used</p>
						<p class="mt-1 font-medium text-foreground">
			...
			<Card class="border-border/60">
				...
				<CardContent class="grid gap-4 text-sm sm:grid-cols-2">
					...
					<div class="sm:col-span-2">
						...
						<p class="mt-1 font-medium wrap-break-word text-foreground">
					...
					<div>
						<p class="text-xs font-medium tracking-wide text-muted-foreground uppercase">Started</p>
						<p class="mt-1 font-medium text-foreground">
					...
					<div>
						...
						<p class="mt-1 font-medium text-foreground">
							...
							<span class="text-xs text-muted-foreground">
								<span aria-hidden="true"> · </span>VMS {formatBytes(
									report.runtime.process.memoryVmsBytes
								)}
							</span>
						</p>
					</div>
			...
			<Card class="border-border/60">
				...
				<CardContent class="space-y-4 text-sm">
					<div class="grid gap-4 sm:grid-cols-2">
						...
						<div>
							<p class="text-xs font-medium tracking-wide text-muted-foreground uppercase">Shell</p>
							<p class="mt-1 font-medium text-foreground">
			...
			<Card class="border-border/60">
				...
				<CardContent class="space-y-4 text-sm">
					...
					<div>
						<p class="text-xs font-medium tracking-wide text-muted-foreground uppercase">Tags</p>
						<div class="mt-2 flex flex-wrap gap-1">
