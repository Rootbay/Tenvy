<script lang="ts">
        ...
        const { toolId, client, agent = null } = $props<{
                toolId: DialogToolId;
                client: Client;
        ...
        const activeWorkspace = $derived(workspaceComponentMap[toolId as keyof typeof workspaceComponentMap]);
                                                        ...
                                                        {:else}
                                                                <Card class="border-dashed">
                                                                        ...
                                                                        <CardContent class="space-y-4 text-sm text-muted-foreground">
                                                                                ...
                                                                                <p>
                                                                                        Add a dedicated workspace component for <span class="font-medium">{tool.title}</span> to elevate the operator experience when you are ready.
                                                                                </p>
                                                                        </CardContent>
                                                                </Card>
                                                        {/if}
                                        ...
                                        {:else if toolId === 'open-url'}
                                                <form class="flex h-full flex-col" onsubmit={handleOpenUrlSubmit}>
                                                        <div class="flex-1 overflow-auto px-6 py-5 space-y-6">
                                                                ...
                                                                {/if}
                                                                <p class="text-xs text-muted-foreground">
                                                                        The request will stage in the task queue for {client.codename}. Confirmation flow and auditing hooks are planned here.
                                                                </p>
                                                        </div>
                                                        <div class="flex items-center justify-end gap-2 border-t border-border/70 bg-muted/30 px-6 py-4">
                                                                <Dialog.Close>
                                        ...
                                        {:else}
                                                <form class="flex h-full flex-col" onsubmit={handleFormSubmit}>
                                                        <div class="flex-1 overflow-auto px-6 py-5 space-y-6">
                                                                ...
                                                                <p class="text-xs text-muted-foreground">
                                                                        Delivery styling and acknowledgement capture will integrate here in a subsequent iteration.
                                                                </p>
                                                        </div>
                                                        <div class="flex items-center justify-end gap-2 border-t border-border/70 bg-muted/30 px-6 py-4">
                                                                <Dialog.Close>
