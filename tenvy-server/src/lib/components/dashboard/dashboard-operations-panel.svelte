<script lang="ts">
        ...
        const severityVariant: Record<DashboardLogEntry['severity'], 'secondary' | 'outline' | 'destructive'> = {
                info: 'secondary',
                warning: 'outline',
                ...
                {:else}
                        <div class="min-h-0 flex-1 space-y-3 overflow-y-auto pr-1">
                                ...
                                {#each $filteredLogs as entry (entry.id)}
                                        <div class="flex flex-col gap-4 rounded-lg border border-border/60 p-4 md:flex-row md:items-center md:justify-between">
                                                <div class="flex items-start gap-3">
                                                        <span class="flex h-10 w-10 items-center justify-center rounded-md border border-border/60 bg-muted/40">
                                                        ...
                                                        <div class="space-y-1">
                                                                ...
                                                                <p class="font-mono text-[0.65rem] tracking-[0.08em] text-muted-foreground uppercase">
                                                                        {entry.action}
                                                                </p>
