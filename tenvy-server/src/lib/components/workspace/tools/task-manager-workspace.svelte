<script lang="ts">
        ...
        function statusBadgeVariant(status: ProcessStatus): 'secondary' | 'outline' | 'default' | 'destructive' {
                switch (status) {
                        case 'running':
                                return 'secondary';
                        case 'sleeping':
        ...
        async function startNewProcess() {
                ...
                recordLog('Start process requested', `${trimmed}${args.length ? ` ${args.join(' ')}` : ''}`, 'queued');
                try {
                        const response = await fetch('/api/task-manager/processes', {
                                method: 'POST',
                                                                        ...
                                                                        {#each filteredProcesses as process (process.pid)}
                                                                                ...
                                                                                >
                                                                                        ...
                                                                                        <td class="px-4 py-2">
                                                                                                ...
                                                                                                <div class="text-xs text-muted-foreground line-clamp-1">{process.command}</div>
                                                                                        </td>
                                        ...
                                        <div class="grid gap-3">
                                                ...
                                                <div class="grid gap-2">
                                                        ...
                                                        <p class="text-xs text-muted-foreground">
                                                                Provide one <code>KEY=value</code> pair per line. Lines beginning with <code>#</code> are ignored.
                                                        </p>
                                                </div>
                                        </div>
                                </CardContent>
                                                ...
                                                <div class="space-y-3 text-sm">
                                                        ...
                                                        <div class="grid gap-2 text-xs text-muted-foreground">
                                                                ...
                                                                <div class="flex justify-between">
                                                                        ...
                                                                        <span>
                                                                                <Badge
                                                                                        variant={statusBadgeVariant(selectedDetail.status)}
                                                                                        class="uppercase"
                                                                                >
                                                                ...
                                                                <div class="flex justify-between">
                                                                        <span>Memory</span>
                                                                        <span class="font-mono text-foreground">{formatMemory(selectedDetail.memory)}</span>
                                                                </div>
                                                                {#if selectedDetail.path}
                                                                        <div class="flex flex-col gap-1">
                                                                                <span>Executable path</span>
                                                                                <span class="font-mono text-foreground break-all">{selectedDetail.path}</span>
                                                                        </div>
                                                                {/if}
