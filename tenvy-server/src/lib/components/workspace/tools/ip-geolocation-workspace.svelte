...
<div class="space-y-6">
        ...
        <Card class="border-dashed">
                <CardHeader>
                        ...
                        <CardDescription>Example location card that will display once the lookup runs.</CardDescription>
                </CardHeader>
                <CardContent class="space-y-3">
                        ...
                        {#if includeMap}
                                <div class="h-40 rounded-lg border border-border/60 bg-gradient-to-br from-sky-500/20 via-sky-500/10 to-transparent"></div>
                        {/if}
                </CardContent>
        </Card>
</div>
