<script lang="ts">
        ...
        const rows = $state<ConnectionRow[]>([
                { local: '10.0.0.4:443', remote: '52.94.76.2:52000', state: 'ESTABLISHED', process: 'nginx.exe' },
                { local: '0.0.0.0:3389', remote: '—', state: 'LISTENING', process: 'svchost.exe' },
                { local: '10.0.0.4:5985', remote: '10.0.5.3:53021', state: 'CLOSE_WAIT', process: 'wmiprvse.exe' }
        ]);
