<script lang="ts">
	...
	function updateVariablesFromSnapshot(snapshot: {
		...
		<CardContent class="space-y-4">
			...
			<div class="grid gap-2 md:grid-cols-2">
				<div class="grid gap-2">
					...
					<Input id="env-key" bind:value={newKey} placeholder="LOG_LEVEL" disabled={saving} />
				</div>
				<div class="grid gap-2">
			...
			<div class="grid gap-2">
				...
				<Input id="env-value" bind:value={newValue} placeholder="debug" disabled={saving} />
			</div>
			<label
	...
	<Card class="border-dashed">
		...
		<CardContent class="space-y-4 text-sm">
			<div class="grid gap-2 md:w-1/2">
				...
				<Input id="env-filter" bind:value={filter} placeholder="PATH" disabled={loading} />
			</div>
			{#if loading}
