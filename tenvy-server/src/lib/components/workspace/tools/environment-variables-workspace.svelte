...
<div class="space-y-6">
        <Card>
                ...
                <CardFooter class="flex flex-wrap gap-3">
                        <Button type="button" variant="outline" onclick={() => addVariable('draft')}>Save draft</Button>
                ...
                <CardContent class="space-y-4 text-sm">
                        ...
                        <ul class="space-y-2">
                                {#if filteredVariables.length === 0}
                                        <li class="rounded-lg border border-border/60 bg-muted/30 p-3 text-muted-foreground">No variables match your filter.</li>
                                {:else}
