...
<div class="space-y-6">
        <Card>
                <CardHeader>
                        ...
                        <CardDescription>Adjust how frequently data is collected and what extras are included.</CardDescription>
                </CardHeader>
                <CardContent class="space-y-6">
                        <div class="grid gap-4 md:grid-cols-3">
                                <div class="grid gap-2">
                                        <Label for="report-feed">Feed type</Label>
                                        <Select type="single" value={feed} onValueChange={(value) => (feed = value as typeof feed)}>
        ...
        <Card class="border-dashed">
                <CardHeader>
                        ...
                        <CardDescription>Representative metrics that will surface once telemetry is live.</CardDescription>
                </CardHeader>
                <CardContent class="grid gap-4 md:grid-cols-3">
                        {#each previewMetrics as metric (metric.label)}
                                <div class="rounded-lg border border-border/60 bg-muted/30 p-4">
                                        <p class="text-xs font-medium uppercase tracking-wide text-muted-foreground">{metric.label}</p>
