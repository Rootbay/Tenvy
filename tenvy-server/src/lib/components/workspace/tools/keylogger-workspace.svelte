...
<div class="space-y-6">
        ...
        <Card>
                ...
                <CardFooter class="flex flex-wrap gap-3">
                        <Button type="button" variant="outline" onclick={() => append('draft')}>
                                Save draft
                        </Button>
                        ...
                        <CardContent class="space-y-2 text-sm text-muted-foreground">
                                <ul class="space-y-2">
                                        {#each latestBatches as batch (batch.batchId)}
                                                <li class="flex items-start justify-between gap-3 rounded-lg border border-border/60 bg-muted/30 p-3">
                                                        <div>
