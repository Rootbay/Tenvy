	...
	<Card>
		...
		<CardContent class="space-y-6">
			...
			<div class="grid gap-2">
				...
				<textarea
					id="message-body"
					class="min-h-32 w-full rounded-md border border-border/60 bg-background px-3 py-2 text-sm focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 focus-visible:outline-none"
					bind:value={body}
			...
			<div class="grid gap-4 md:grid-cols-2">
				<div class="grid gap-2">
					...
					<Select
						type="single"
						value={style}
						onValueChange={(value) => (style = value as typeof style)}
					>
			...
			>
				<div>
					...
					<p class="text-xs text-muted-foreground">
						Prevent dismissal without operator confirmation
					</p>
				</div>
				<input
					type="checkbox"
